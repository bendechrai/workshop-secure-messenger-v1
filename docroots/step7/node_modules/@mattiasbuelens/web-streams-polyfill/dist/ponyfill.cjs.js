...
var FakeSymbol = typeof Symbol === 'function' && typeof Symbol.iterator === 'symbol' ? Symbol : function (description) {
...
var helpers = createCommonjsModule(function (module, exports) {
  ...
  var isFakeDetached = FakeSymbol('is "detached" for our purposes');
...
var AbortSteps = FakeSymbol('[[AbortSteps]]');
var ErrorSteps = FakeSymbol('[[ErrorSteps]]');

var WritableStream =
/*#__PURE__*/
function () {
  function WritableStream(underlyingSink, _temp) {
    ...
    var _ref = _temp === void 0 ? {} : _temp,
        ...
        highWaterMark = _ref$highWaterMark === void 0 ? 1 : _ref$highWaterMark;
...
var ArrayBufferCopy = require$$0.ArrayBufferCopy,
    ...
    CreateIterResultObject = require$$0.CreateIterResultObject,
...
var CancelSteps = FakeSymbol('[[CancelSteps]]');
var PullSteps = FakeSymbol('[[PullSteps]]');

var ReadableStream =
/*#__PURE__*/
function () {
  function ReadableStream(underlyingSource, _temp) {
  ...
  _proto.getReader = function getReader(_temp2) {
  ...
  _proto.pipeThrough = function pipeThrough(_ref3, options) {
...
function ReadableStreamError(stream, e) {
  ...
  if (IsReadableStreamDefaultReader(reader) === true) {
    for (var _i4 = 0, _reader$_readRequests4 = reader._readRequests; _i4 < _reader$_readRequests4.length; _i4++) {
...
function TransformStreamDefaultSinkCloseAlgorithm(stream) {
  ...
  var flushPromise = stream._transformStreamController._flushAlgorithm(); // Return a promise that is fulfilled with undefined on success.
...
//# sourceMappingURL=ponyfill.cjs.js.map
